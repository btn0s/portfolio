...
Strella is my dream project—a node-based IDE where designers and engineers speak the same language. Inspired by Unreal Engine's [Blueprints](https://dev.epicgames.com/documentation/en-us/unreal-engine/blueprints-visual-scripting-in-unreal-engine), it replaces the fragmented workflow of Figma-to-code with a unified canvas where visual components connect directly to functional logic, eliminating the translation gap.
