...
Strella currently exists in the wireframes you see here, and in the technical documentation and specs available in the [GitHub repository](https://github.com/btn0s/strella/tree/main/docs). The dream is very much alive and in active progress.

This is the most ambitious thing I've ever built—it's a bet on a better kind of tool that closes the gap between design and implementation, making software creation visual, expressive, and collaborative from the start.

I'm looking for like-minded individuals who believe in better tools for UI development and want to help shape the future. If you want to be one of those people—or just follow along—[sign up at strella.dev](https://strella.dev), track progress on [GitHub](https://github.com/btn0s/strella), or follow me on [Twitter](https://x.com/btn0s).
